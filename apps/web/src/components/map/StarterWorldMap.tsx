    ...
    >
      <div style={{ marginBottom: 14 }}>
        ...
        <p style={{ color: '#94a3b8', marginBottom: 0, marginTop: 8 }}>
          Use the mouse wheel to zoom and drag to pan. Select one or more idle friendly units in
          the province panel, then click an adjacent highlighted province to move them.
          Double-click a province to select all idle friendly units there.
        </p>
      </div>

      <MapViewport
        ariaLabel="REWAR starter world"
        baseViewBox={{ x: 0, y: 0, width: 640, height: 420 }}
        maxWidth={720}
          ...
          return (
            <>
              ...
              {worldState.provinces.map((province) => {
                ...
                const unitNation =
                  unitNationIds.size === 1
                    ? nationById.get(provinceUnits[0]?.nationId ?? '') ?? ownerNation
                    : ownerNation;
